...
function initToolbox() {
	...
	const order = [
		'События', // точки входа
		'Сцены', // загрузка/переходы, контекст
		'Данные', // загрузка/хранение данных
		'Переменные', // состояние
		'Логика', // условия, ветвления
		'Группы', // организация сущностей
		'Объекты', // создание/управление объектами
		'Физика', // коллизии, силы
		'Движение', // перемещение
		'Камера', // обзор сцены
		'Анимация', // визуальная динамика
		'Текст', // текстовые элементы
		'Интерфейс', // UI
		'Окно', // системные/оконные операции
		'Ввод', // пользовательский ввод
		'Звук', // аудио
		'Система', // API
		'Отладка', // логирование, инспекция
	]
